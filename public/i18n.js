...
const TRANSLATIONS = {
  en: {
    ...
    "lobby.rule4_simple": "First to collect <strong>3 trios</strong> or the <strong>7 trio</strong> wins.",
    "lobby.rule4_spicy": "First to collect <strong>2 connected trios</strong> (numbers that add up to 7 or differ by 7) or the <strong>7 trio</strong> wins.",
    ...
    "lobby.mode_label": "Game mode",
    "lobby.mode_simple": "Simple",
    "lobby.mode_spicy": "Spicy",
    "lobby.mode_simple_desc": "Win with 3 trios or the 7 trio.",
    "lobby.mode_spicy_desc": "Win with 2 connected trios or the 7 trio. Connected = numbers that add up to 7 or differ by 7.",
    "lobby.mode_locked": "Only the host can change the mode.",
    ...
    "game.mode_spicy_tag": "SPICY",
    "game.spicy_hint_first": "🎯 Spicy: win with 2 connected trios. Grab any trio to start.",
    "game.spicy_hint_targets": "🎯 To win, complete a trio of: <b>{nums}</b>",
    ...
    "winner.detail_connected": "With the connected {a} and {b} trios.",
  ...
  es: {
    ...
    "lobby.rule4_simple": "Gana quien primero reúna <strong>3 trios</strong> o el <strong>trio del 7</strong>.",
    "lobby.rule4_spicy": "Gana quien primero reúna <strong>2 trios conectados</strong> (números que suman 7 o se diferencian en 7) o el <strong>trio del 7</strong>.",
    ...
    "lobby.mode_label": "Modo de juego",
    "lobby.mode_simple": "Simple",
    "lobby.mode_spicy": "Picante",
    "lobby.mode_simple_desc": "Gana con 3 trios o el trio del 7.",
    "lobby.mode_spicy_desc": "Gana con 2 trios conectados o el trio del 7. Conectados = números que suman 7 o se diferencian en 7.",
    "lobby.mode_locked": "Solo el anfitrión puede cambiar el modo.",
    ...
    "game.mode_spicy_tag": "PICANTE",
    "game.spicy_hint_first": "🎯 Picante: gana con 2 trios conectados. Consigue un trio para empezar.",
    "game.spicy_hint_targets": "🎯 Para ganar, completa un trio de: <b>{nums}</b>",
    ...
    "winner.detail_connected": "Con los trios conectados {a} y {b}.",
